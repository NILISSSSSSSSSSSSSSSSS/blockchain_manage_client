<template>
    <div class="container">
        <bread title="系统配置" desc="系统的一些基础配置" :list="breadNav"></bread>
        <div class="recharge-box" v-if="config">
            <div class="recharge">
                <header class="head">系统配置 {{siteDomain}}</header>
                <section class="content">
                    ...
                    <ul class="base">
                        ...
                        <li class="item" style="flex-wrap: wrap;">
                           ...
                           <p style="font-size: 12px; color: red; margin-left:120px;margin-bottom: 10px;">(更改手续费60秒之后生效)</p>
                        </li>
                        <li class="item">
...
export default {
    ...
    methods: {
        ...
        _getSysconf() {
          ...
          this.logo = data.logo || '';
          this.enableFutures = data.enableFutures != undefined? data.enableFutures: false;
          this.futuresAddr = data.futuresAddr != undefined? data.futuresAddr: '';
          ...
          this.siteDomain = data._id || "";
          this.siteEmail = data.siteEmail || "";
          this.smtpAddr = data.smtpAddr || "";
          this.smtpPort = data.smtpPort || "";
          this.emailUser = data.emailUser || "";
          this.emailPasswd = data.emailPasswd || "";
          this.lampRefresh = data.lampRefresh || 0;
          this.futuresFlag = data.enableFutures || "";
          this.usdtFlag = data.enableUSDT || "";
          this.futuresExRate = data.futuresExRate || ""
          this.futuresSymbol = data.futuresSymbol || ""
          this.issueCurrencyFee = data.issueCurrencyFee ? data.issueCurrencyFee + '' : "0"
          this.issueCurrencyEmail = data.issueCurrencyEmail || ""
        },
        _getCurrency() {
        ...
        commit() {
            ...
            let postObj = {
                ...
                futuresloginPort:this.futuresloginPort.trim()
            };
            if (!this.once) {
                this.once = true;
